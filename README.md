...
- **Lab 0**: [SW installation](setup.md) and beginner's guides: [[Lab0-00-begin-python](xxx)] [[Lab0-01-jupyter-markdown](xxx)] [[Lab0-02-begin-pandas](xxx)] [[Lab0-03-begin-medim-dicom](xxx)] (and [prog4comp-SL-HPL](./prog4comp-SL-HPL) for going deeper in numerical computing)
